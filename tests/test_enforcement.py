...
"""
ARIS â€” Enforcement & Litigation Agent Tests
"""
import json
import sys
import types
...
# â”€â”€ RSS sample fixtures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class TestPenaltyExtraction(unittest.TestCase):
    ...
    def test_euro_amount(self):
        result = self._extract("GDPR fine of â‚¬750,000 imposed by DPC")
        self.assertIsNotNone(result)
...
FTC_MOCK_JSON = {
    "items": [
        {
            "title":   "FTC Takes Action Against Company for Using Deceptive AI Algorithms",
            "summary": "The FTC filed a complaint alleging the company used deceptive "
                       "artificial intelligence algorithms to target vulnerable consumers with "
                       "discriminatory automated decision-making in credit scoring.",
            "url":     "https://www.ftc.gov/news/press-releases/2025/01/ftc-action-ai-algorithms",
            "created": "2025-01-15",
        },
        {
            "title":   "FTC Issues Report on Marine Wildlife Protection",
            "summary": "The FTC released guidance on marine wildlife conservation efforts "
                       "and fishing regulations in the Pacific Northwest region.",
            "url":     "https://www.ftc.gov/news/2025/01/marine-wildlife",
            "created": "2025-01-13",
        },
        {
            "title":   "FTC Settles with Employer Over Algorithmic Hiring Bias for $2.5 million",
            "summary": "The company agreed to pay $2.5 million civil penalty and stop "
                       "using machine learning algorithms that produced discriminatory outcomes "
                       "in automated hiring decisions. The settlement requires bias audits.",
            "url":     "https://www.ftc.gov/news/press-releases/2025/01/ftc-algorithmic-hiring",
            "created": "2025-01-10",
        },
    ]
}
...
class TestFTCSource(unittest.TestCase):
    ...
    def _fetch(self, days=3650):
        """Helper: mock both http_get (JSON API) and http_get_text (not used by FTC)."""
        src = self._source()
        with patch('sources.enforcement_agent.http_get', return_value=FTC_MOCK_JSON):
            with patch('sources.enforcement_agent.http_get_text', return_value=''):
