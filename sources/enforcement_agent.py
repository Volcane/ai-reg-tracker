...
US FEDERAL AGENCIES (all RSS/JSON, no key required)
  FTC    â€” Algorithmic bias, dark patterns, AI fraud, ROSCA violations
             https://www.ftc.gov/rss.xml
  SEC    â€” AI fraud, algorithmic manipulation, AI-generated disclosures
             https://www.sec.gov/rss/litigation/litreleases.xml
             https://efts.sec.gov/LATEST/search-index (EDGAR full-text)
  CFPB   â€” Automated underwriting, credit scoring, BNPL algorithm enforcement
             https://www.consumerfinance.gov/activity-log/rss/
  EEOC   â€” Employment AI discrimination (hiring, promotion, performance)
             https://www.eeoc.gov/newsroom/rss
  DOJ    â€” Civil rights AI discrimination in housing, lending, criminal justice
             https://www.justice.gov/crt/rss

INTERNATIONAL (RSS, no key required)
  ICO    â€” UK GDPR Article 22 automated decisions, AI data processing
  (UK)     https://ico.org.uk/action-weve-taken/enforcement/rss/

US COURTS (free REST API, optional free token for higher rate limits)
  CourtListener â€” Federal court opinions and dockets from PACER/RECAP
...
# â”€â”€ Enforcement-specific keyword patterns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def _extract_penalty(text: str) -> Optional[str]:
    ...
    patterns = [
        ...
        r'â‚¬\s*([\d,]+(?:\.\d+)?)\s*(million|billion|thousand)?',
...
class SECEnforcementSource:
    """
    SEC enforcement â€” AI fraud, algorithmic manipulation, AI-generated disclosures.
...
class CFPBEnforcementSource:
    """
    CFPB enforcement actions â€” automated underwriting, credit scoring,
...
class DOJEnforcementSource:
    """
    DOJ Civil Rights Division â€” AI discrimination in housing, lending,
...
class CourtListenerSource:
    """
    CourtListener (Free Law Project) â€” federal court opinions and dockets
...
class EnforcementAgent:
    ...
    def fetch_all(self, lookback_days: int = 90) -> Dict[str, Any]:
        ...
        log.info("Starting enforcement fetch (lookback=%d days)â€¦", lookback_days)
