...
Design principles
-----------------
GROUNDED â€” every factual claim in the answer is tied to a specific passage
...
HONEST â€” when the corpus does not contain enough information to answer a
...
MULTI-JURISDICTION â€” questions like "how does the EU AI Act compare to
...
FOLLOW-UP AWARE â€” each response includes 3 suggested follow-up questions
...
SYSTEM_PROMPT = """You are ARIS â€” an Automated Regulatory Intelligence System covering AI regulation and data privacy law.
...
def _build_context(passages: List[Dict]) -> str:
    ...
    lines = ["REGULATORY CORPUS â€” RETRIEVED PASSAGES", "=" * 50, ""]
...
def _build_prompt(question: str, passages: List[Dict],
    ...
    if conversation_history:
        ...
        for turn in conversation_history[-3:]:   # last 3 turns for context
            ...
            turns.append(f"A: {ans_clean[:500]}â€¦" if len(ans_clean) > 500 else f"A: {ans_clean}")
...
class QAAgent:
    ...
    def ask(self,
        ...
        Args:
            ...
            jurisdiction:         Optional filter â€” only retrieve passages
        ...
        # â”€â”€ Retrieve passages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        try:
        ...
        # â”€â”€ Call LLM â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
