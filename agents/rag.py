...
"""
ARIS â€” Retrieval-Augmented Generation (RAG) Engine
...
------------
CHUNKING
  Documents and baselines are split into passages of ~800 tokens (â‰ˆ3000 chars).
...
CHUNK_SIZE   = 3000   # characters (~750 tokens) â€” fits ~10 chunks in context
    ...
    def _stringify(obj: Any, depth: int = 0) -> str:
        ...
        if isinstance(obj, list):
            ...
            for item in obj:
                ...
                if s:
                    parts.append(f"â€¢ {s}" if depth == 0 else s)
            return "\n".join(parts)
        return str(obj) if obj is not None else ""

    # Overview â€” always a top-level passage
...
class PassageTFIDF:
    ...
    def query(self, text: str, top_k: int = 30) -> List[Tuple[int, float]]:
        ...
        # idx.doc_ids are strings like "123" â€” convert back to ints
...
class PassageRetriever:
    ...
    Singleton â€” loaded once at server startup.
    """
    ...
    def ensure_ready(self) -> None:
        ...
        if self._tfidf.load():
            ...
            log.info("Q&A passage index not found â€” building on first query")
    ...
    def retrieve(self, question: str, top_k: int = MAX_PASSAGES,
        ...
        results = []
        seen_sources: Dict[str, int] = {}   # source_id â†’ passages included
...
def build_passage_index(force: bool = False) -> Dict[str, int]:
    ...
    log.info("Building Q&A passage indexâ€¦")
    ...
    # â”€â”€ 1. Baselines â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    if not BASELINES_DIR.exists():
    ...
    # â”€â”€ 2. Database documents (summaries + full text) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    try:
    ...
    # â”€â”€ 3. Persist passages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    conn = sqlite3.connect(DB_PATH)
    ...
    # â”€â”€ 4. Build TF-IDF index â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    from utils.db import get_session, QAPassage as _QAPassage
    with get_session() as session:
